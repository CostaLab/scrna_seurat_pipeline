...
if(hallmark_sample_stage %ni% names(scrna@tools)){
  stop(glue("ERORR:hallmark stages comparing hasn't been calculated for cluster:{cluster_use}\n Please run [scrna_pathway_stage]!!!"))
}
...
## Empty EV vs CALR deletion  hallmark down
