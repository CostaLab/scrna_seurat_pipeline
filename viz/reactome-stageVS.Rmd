...
reactome_sample_stage <-paste0("pathway_stage_", cluster_use)
if(reactome_sample_stage %ni% names(scrna@tools)){
  stop(glue("ERORR:reactome stages comparing hasn't been calculated for cluster:{cluster_use}\n Please run [scrna_pathway_stage]!!!"))
}

all_reactomeup_list <-  scrna@tools[[reactome_sample_stage]]$reactomeup
all_reactomedown_list <-  scrna@tools[[reactome_sample_stage]]$reactomedown
```




## Empty EV vs CALR deletion  reactome up
...
## Empty EV vs CALR deletion  reactome down
