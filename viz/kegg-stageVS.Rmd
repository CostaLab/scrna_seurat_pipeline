...
kegg_sample_stage <-paste0("pathway_stage_", cluster_use)
if(kegg_sample_stage %ni% names(scrna@tools)){
  stop(glue("ERORR:kegg stages comparing hasn't been calculated for cluster:{cluster_use}\n Please run [scrna_pathway_stage]!!!"))
}
all_keggup_list <-  scrna@tools[[kegg_sample_stage]]$keggup
all_keggdown_list <-  scrna@tools[[kegg_sample_stage]]$keggdown
```
...
## Empty EV vs CALR deletion  kegg up
...
## Empty EV vs CALR deletion  kegg down
