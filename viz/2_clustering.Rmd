...
clin_violins <- list.files(params$report_plots_folder_png,
  pattern = paste0("^clinical_violin_.*_", params$cluster, "\\.png$"), full.names = TRUE)
clin_umaps <- list.files(params$report_plots_folder_png,
  pattern = paste0("^clinical_umap_.*_", params$cluster, "\\.png$"), full.names = TRUE)
all_clin <- sort(c(clin_violins, clin_umaps))
