...
### Clusters Resolution
```{r clustree_resolution, out.width="100%", echo=FALSE}
knitr::include_graphics(
  file.path(
    params$report_plots_folder_png,
    paste0("clustree_resolution_",params$cluster,".png")
  )
)
```

```{r umap_resolution_list, out.width="100%", echo=FALSE}
knitr::include_graphics(
  file.path(
    params$report_plots_folder_png,
    paste0("umap_resolution_list_",params$cluster,".png")
  )
)
```
...
### Clusters Statistic
```{r cluster_statistics, out.width="100%", echo=FALSE}
flist = grep(
  "cluster_statistics_",
  list.files(
    params$report_plots_folder_png,
...
### Proportion
```{r cluster_sample_proportions, out.width="100%", echo=FALSE}
knitr::include_graphics(
  file.path(
    params$report_plots_folder_png,
...
### Amount Distribution
```{r cluster_sample_distribution, out.width="100%", echo=FALSE}
knitr::include_graphics(
  file.path(
    params$report_plots_folder_png,
...
### MCA annotation
```{r mca_annotate, out.width="100%", echo=FALSE}
knitr::include_graphics(
  file.path(
    params$report_plots_folder_png,
...
```
```{r mca_annotate_hover, out.width="100%", echo=FALSE, eval=FALSE}
plt = readRDS(
  file.path(
...
### External Annotation
```{r external_annotation, out.width="100%", echo=FALSE}
knitr::include_graphics(
  file.path(
    params$report_plots_folder_png,
...
```
```{r external_annotation_hover, out.width="100%", echo=FALSE, eval=FALSE}
plt = readRDS(
  file.path(
    params$report_plots_folder,
