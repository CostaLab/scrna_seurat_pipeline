...
```
```{r mca_annotate_hover, out.width="100%", echo=FALSE, eval=FALSE, eval=(params$cluster!="singleton")}
plt = readRDS(
  file.path(
...
```
```{r hcl_annotate_hover, out.width="100%", echo=FALSE, eval=FALSE, eval=(params$cluster!="singleton")}
plt = readRDS(
  file.path(
    params$report_plots_folder,
...
```
```{r external_annotation_hover, out.width="100%", echo=FALSE, eval=FALSE, eval=(params$cluster!="singleton")}
plt = readRDS(
  file.path(
    params$report_plots_folder,
