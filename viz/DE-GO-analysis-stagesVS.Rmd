...
## Plot Empty EV vs CALR deletion
...
#### Empty EV vs CALR deletion Volcano
...
#### Empty EV vs CALR deletion  GO up
...
#### Empty EV vs CALR deletion  GO down
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='hide', fig.width=13, fig.height=20}
a_vs <- "Empty EV.vs.CALR deletion"
...
#### UMAP for Empty EV vs CALR deletion
