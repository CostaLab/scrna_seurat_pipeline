...
fname=file.path(
  ...
  glue("progeny_heatmap_stars_vs_MxCre.vs.B_MxCre_cluster-{params$cluster}.png")
)
...
fname=file.path(
  params$report_plots_folder_png,
  glue("progeny_heatmap_vs_MxCre.vs.B_MxCre_cluster-{params$cluster}.png")
)
if(file.exists(fname)) knitr::include_graphics(fname)
```
