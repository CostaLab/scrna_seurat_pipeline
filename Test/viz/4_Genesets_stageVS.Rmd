---
title: "Between stageVS  analysis"
...
flist = stringr::str_sort(grep(
  glue("Geneset_ridges_vs_stageVS_.*_cluster-{params$cluster}.png"),
  list.files(
...
#Geneset_violin_vs_MxCre.vs.B_MxCre_.*_cluster-seurat_clusters.png
flist = stringr::str_sort(grep(
  glue("Geneset_violin_vs_MxCre.vs.B_MxCre_.*_cluster-seurat_clusters.png"),
  list.files(
    params$report_plots_folder_png,
    full.names=TRUE
  ),
