...
## MxCre vs Csnk  kegg up

```{r, out.width="100%", echo=FALSE}
fname=file.path(
  params$report_plots_folder_png,
  glue("kegg_up_genes_heatmap_vs_MxCre.vs.Csnk_cluster-{params$cluster}.png")
)
...
flist = stringr::str_sort(grep(
  glue("top10-keggup_bar_vs_MxCre.vs.Csnk_cluster-{params$cluster}_p"),
  list.files(
    params$report_plots_folder_png,
    full.names=TRUE
  ),
...
## MxCre vs Csnk  kegg down

```{r, out.width="100%", echo=FALSE}
fname=file.path(
  params$report_plots_folder_png,
  glue("kegg_down_genes_heatmap_vs_MxCre.vs.Csnk_cluster-{params$cluster}.png")
)
if(file.exists(fname)) knitr::include_graphics(fname)
```
...
### down genes top 10
flist = stringr::str_sort(grep(
  glue("top10-keggdown_bar_vs_MxCre.vs.Csnk_cluster-{params$cluster}_p"),
  list.files(
    params$report_plots_folder_png,
    full.names=TRUE
  ),
